	...
	*/
	...
	public:
		...
		*/
		...
		glm::vec3 position; ///< location in 3-space
...
//struct halfEdge
//{	
//	int vertexIndex; // Index into the vertex array.
//	
//	int faceIndex; // Index into the face array.
//	
//	int halfEdgeIndex; // Index into the edges array.
//	
//	int oppositeHalfEdgeIndex; // Index into the halfedges array.
//	
//	int nextHalfEdgeIndex; // Index into the halfedges array.
//
//	halfEdge(){
//		vertexIndex = -1;
//		faceIndex = -1;
//		halfEdgeIndex = -1;
//		oppositeHalfEdgeIndex = -1;
//		nextHalfEdgeIndex = -1;
//	}
//};
//
...
//	{
//		return (firstVertexIndex == a.firstVertexIndex && secondVertexIndex == a.secondVertexIndex);
//	}
//};
//
//
...
//	std::vector<unsigned int> vertexToHalfEdge;
//
//public:
//	HalfEdgeMesh();
//	HalfEdgeMesh(std::vector<glm::vec3> _vertices, std::vector<unsigned int> _indices);
//	~HalfEdgeMesh();
//
//	std::vector<edge> createEdgeList();
//
//	halfEdge getHalfEdge(int halfEdgeIndex);
//
//	int getNextHalfEdge(int halfEdgeIndex);
//	halfEdge getNextHalfEdge(halfEdge he);
//
//	halfEdge getOppositeHalfEdge(halfEdge he);
//
//	void printTriangleFan(int vertexId);
//};
//
